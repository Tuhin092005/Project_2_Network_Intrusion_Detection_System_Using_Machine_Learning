...
sns.heatmap(
    ...
    fmt='d',
    cmap='Blues',
    xticklabels=["Normal Network Traffic", "Intrusion"],
    yticklabels=["Normal Network Traffic", "Intrusion"]
)
